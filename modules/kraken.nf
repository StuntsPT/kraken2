...
process kraken2 {
    ...
    classified_reads = params.classified_out ? "--classified-out " + path("${id}_" + params.classified_out) : ""
    unclassified_reads = params.unclassified_out ? "--unclassified-out " + path("${id}_" + params.unclassified_out) : ""
